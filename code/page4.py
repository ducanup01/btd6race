...
for id in selected_chunk.index[::-1]:
    ...
    with colleft:
        ...
        with col1:
            st.image(image_paths["1th"], use_container_width="auto")
        ...
        col1, col2 = st.columns([1, 8], vertical_alignment="center")
        with col1:
            st.image(image_paths["2th"], use_container_width="auto")
        ...
        col1, col2 = st.columns([1, 8], vertical_alignment="center")
        with col1:
            st.image(image_paths["3th"], use_container_width="auto")
        ...
        col1, col2 = st.columns([1, 8], vertical_alignment="center")
        with col1:
            st.image(image_paths["4th"], use_container_width="auto")
